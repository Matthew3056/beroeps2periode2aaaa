...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_dish'])) {
    ...
    if (empty($name) || empty($description) || $price <= 0) {
        ...
        try {
            ...
            $error = 'Fout bij toevoegen gerecht.';
        }
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_dish'])) {
    ...
    try {
        ...
        $error = 'Fout bij bijwerken gerecht.';
    }
}
            ...
            <form method="POST" class="dish-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="image" placeholder="bijv. tonkotsu.jpg">
                    </div>
                    <div class="form-group">
                        <label>
            ...
            <?php foreach ($dishes as $dish): ?>
                <div class="dish-card-admin">
                    ...
                    <div class="dish-content">
                        ...
                        <form method="POST" class="dish-edit-form">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <input type="text" name="image" value="<?php echo htmlspecialchars($dish['image']); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>
